...
class AppointmentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.reserveButton.setOnClickListener {
            if (::selectedDay.isInitialized) {
                ...
                val patientId = 0 // You need to get the actual patient ID
                reserveAppointment(patientId, doctorName, doctorId, selectedDay, location.toString(), doctorImage)
            } else {
    ...
    private fun cancelReservation() {
        ...
        val patientId = 0 // Get the actual patient ID
    ...
    private fun reserveAppointment(patientId: Int, doctorName: String, doctorId: Int, appointmentDate: String, location: String, doctorImage: String) {
